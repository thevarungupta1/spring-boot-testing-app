package com.thevarungupta.spring.boot.testing.app.integration;
...
public class EmployeeControllerTest {
    ...
    @Test
    public void givenEmployeeObject_whenCreatedEmployee_thenReturnedSavedEmployee() throws Exception {
        // given
